      ...
      <div className="min-h-screen bg-black text-white">
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-400 font-[200]">Loading your links...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <div className="py-12 px-4">
        ...
        <div className="flex justify-between items-center mb-12">
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm text-white py-4 px-8 font-[200] hover:bg-white/10 transition-colors"
            >
              Log out
            </button>
          </div>
        ...
        {error && (
          <div className="bg-red-900/20 border border-red-800 text-red-400 px-4 py-3 rounded-2xl mb-6 font-[200]">
            {error}
          </div>
        )}
        ...
        {analytics && (
          <div className="mb-8">
            <h2 className="text-3xl font-[200] text-white mb-6">My Analytics</h2>
            
            {/* Statistiques principales */}
            <div className="grid md:grid-cols-4 gap-6 mb-6">
              <div className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm p-6">
                <h3 className="text-lg font-[200] text-gray-400 mb-2">Total Links</h3>
                <p className="text-3xl font-[200] text-violet-400">{analytics.totalLinks}</p>
              </div>
              <div className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm p-6">
                <h3 className="text-lg font-[200] text-gray-400 mb-2">Total Clicks</h3>
                <p className="text-3xl font-[200] text-violet-400">{analytics.totalClicks}</p>
              </div>
              <div className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm p-6">
                <h3 className="text-lg font-[200] text-gray-400 mb-2">Active Countries</h3>
                <p className="text-3xl font-[200] text-violet-400">{analytics.topCountries.length}</p>
              </div>
              <div className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm p-6">
                <h3 className="text-lg font-[200] text-gray-400 mb-2">Top Country</h3>
                <p className="text-lg font-[200] text-white">
            ...
            {analytics.topCountries.length > 0 && (
              <div className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm mt-6">
                <div className="px-6 py-4 border-b border-gray-700">
                  <h3 className="text-lg font-[200] text-white">Details by country</h3>
                </div>
                  ...
                  <table className="w-full">
                    ...
                    <tbody className="divide-y divide-gray-700">
                      {analytics.topCountries.map((country, index) => (
                        <tr key={country.country} className="hover:bg-white/5">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="text-sm text-white font-[200]">{country.clicks}</span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="text-sm text-gray-400 font-[200]">{country.links}</span>
                          </td>
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className="text-sm text-gray-400 font-[200]">
        ...
        {links.length === 0 ? (
          <div className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm p-12 text-center">
            ...
            <p className="text-gray-400 mb-6 font-[200]">
          ...
          <div className="rounded-2xl border border-gray-700 bg-white/5 backdrop-blur-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-gray-700">
              <h2 className="text-lg font-[200] text-white">
                    ...
                    <tr key={link.id} className="hover:bg-white/5">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center gap-2">
                          <code className="bg-gray-700 px-2 py-1 rounded text-sm text-white font-[200]">
                            {link.shortUrl}
                          </code>
                          <button
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-[200] bg-violet-900/30 text-violet-400">
                          {link.clicks} clicks
                        </span>
                      </td>
